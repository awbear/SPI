...
export class Lexer {
    ...
    gen_token(type: TokenType) {
      return new Token(type, type, this.lineno, this.column)
    }
    ...
    get_next_token() {
        while(this.current_char) {
            ...
            if (this.current_char === ',') {
                this.advance();
                return this.gen_token(TokenType.COMMA)
            }

            if (this.current_char === '+') {
                this.advance();
                return this.gen_token(TokenType.PLUS);
            }

            if (this.current_char === '-') {
                this.advance();
                return this.gen_token(TokenType.MINUS) 
            }

            if (this.current_char === '*') {
                this.advance();
                return this.gen_token(TokenType.MUL);
            }

            if (this.current_char === '/') {
                this.advance();
                return this.gen_token(TokenType.FLOAT_DIV)
            }

            if (this.current_char === '(') {
                this.advance();
                return this.gen_token(TokenType.LPAREN);
            }

            if (this.current_char === ')') {
                this.advance();
                return this.gen_token(TokenType.RPAREN);
            }
            ...
            if (this.current_char === ':' && this.peek() === '=') {
                this.advance();
                this.advance();
                return this.gen_token(TokenType.ASSIGN)
            }

            if (this.current_char === ':') {
                this.advance()
                return this.gen_token(TokenType.COLON);
            }

            if (this.current_char === ';') {
                this.advance();
                return this.gen_token(TokenType.SEMI);
            }

            if (this.current_char === '.') {
                this.advance();
                return this.gen_token(TokenType.DOT);
            }
